...
export const resultImages = [
  ...
  '/results/result-24.webp',
  '/results/result-4.webp',
  '/results/result-17.webp',
  '/results/result-28.webp',
  '/results/result-8.webp',
  '/results/result-20.webp',
  '/results/result-15.webp',
  '/results/result-7.webp',
]

export const additionalResultImages = [
  '/results/result-3.webp',
  '/results/result-14.webp',
  '/results/result-26.webp',
  '/results/result-9.webp',
  '/results/result-21.webp',
  '/results/result-5.webp',
  '/results/result-18.webp',
  '/results/result-10.webp',
  '/results/result-23.webp',
]

export const evenMoreResultImages = [
  '/results/result-2.webp',
  '/results/result-16.webp',
  '/results/result-27.webp',
  '/results/result-6.webp',
  '/results/result-19.webp',
  '/results/result-11.webp',
  '/results/result-25.webp',
  '/results/result-13.webp',
